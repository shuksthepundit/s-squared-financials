...
// Price ranges below are anchored to real market levels as of August 16, 2026 (checked against
...
const COMMODITY_ANCHOR_DATE = "16 Aug 2026";
const COMMODITIES = [
  ...
  { sym: "BRENT", name: "Crude Oil (Brent)", key: "BRENT", icon: "fuel", priceMin: 84, priceMax: 92, driver: "Naval blockade and stalled Hormuz talks push Brent toward $90." },
  ...
  return (
    <div style={{ minHeight: "100vh", background: COLORS.bg, color: COLORS.text, fontFamily: F_BODY }}>
      ...
      <div style={{ maxWidth: 1360, margin: "0 auto", padding: "20px 22px 60px" }}>
        ...
        {tab === "cross" && (
          <>
            <SectionTitle icon={Activity} title="Cross-Asset Updates" sub={`Crypto · Commodities · Agricultural · Indices · Futures — price, change, and daily demand vs. supply ($B). Commodity prices anchored to real market levels as of ${COMMODITY_ANCHOR_DATE}.`} />
        ...
        {tab === "cfd" && (
          <>
            <SectionTitle icon={Boxes} title="All CFD Instruments" sub={`${filteredCfd.length} contracts-for-difference with live-updating prices, across FX, indices, commodities, agricultural, crypto, shares & bonds. Commodity prices anchored to real market levels as of ${COMMODITY_ANCHOR_DATE}.`} />
            <div style={{ display: "flex", gap: 6, marginBottom: 16, flexWrap: "wrap" }}>
              {cfdCategories.map((c) => (
