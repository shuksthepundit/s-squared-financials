...
export default function SSquaredFinancials() {
  ...
  const calcLeverage = parseLeverage(calcInstrument.spec.leverage);
        ...
        {tab === "calculator" && (
          <>
            ...
            <Panel style={{ padding: 18, marginBottom: 18 }}>
              ...
              <div style={{ fontSize: 11, color: COLORS.mutedDim, marginTop: 10 }}>{calcUnitsLabel} · Indicative leverage {calcInstrument.spec.leverage} · Live price used automatically when a field is left blank.</div>
            </Panel>
